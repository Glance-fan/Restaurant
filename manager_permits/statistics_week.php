...
<body>
    <div class="blue-bg statistic-wrapper">
        ...
        <div class="statistic-scrollable"><?php 
            ...
            $query = pdo()->prepare('SELECT * FROM total_week');
            $query->execute();
            echo '<div class="title">Всего за неделю: '.$query->fetchColumn().'</div>';
        ?>
